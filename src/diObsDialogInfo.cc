...
const std::vector<ObsDialogInfo::Par> pars = {{"pos", ObsDialogInfo::pt_std, -1, 0, "Position", 0, 0},
                                              ...
                                              {"RoadSurfaceTemperature", ObsDialogInfo::pt_temp, -1, 1, "Thermodynamic temperature of road", -50, 50},
                                              {"TdTdTd", ObsDialogInfo::pt_temp, -1, 1, "Dew point temperature", -50, 50},
                                              {"UU", ObsDialogInfo::pt_std, -1, 1, "Relative humidity", 0, 100},
                                              ...
                                              {"StationName", ObsDialogInfo::pt_std, -1, 0, "StationName", 0, 0},
